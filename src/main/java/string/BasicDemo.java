...
//    c.检査s1 是否有前缀"AAA", 然后将结果赋值给一个布尔变量b1。
        boolean b1 = s1.startsWith("AAA"); // 開頭是否為 AAA
        boolean b11 = s1.startsWith("AAA", 2); // 從第二個字符為開頭，並進行比較是否為 AAA
//
//    f.检査s1 是否有后缀"AAA", 然后将结果赋值给一个布尔变量b2。
        boolean b2 = s1.endsWith("AAA"); // 結尾是否為 AAA
//
...
//    o.将s1中第一次出现的字符 e 的下标赋值给一个int型变量x5。
        int x5 = s1.indexOf('e');
        // indexOf 從左往又找
        "welcome to java".indexOf('e'); // return 1
        "welcome to java".indexOf('o', 5); // return 9 (從第五位置開始尋找 "o" 的位置)
        "welcome to java".indexOf('E'); // return -1
        "welcome to java".indexOf("java"); // return 11
        // indexOf 從右往左找
        "welcome to java".lastIndexOf("w"); // return 0
        "welcome to java".lastIndexOf("c", 5); // return 3,從左邊往右第五個，並向左最近的'c'
        "welcome to java".lastIndexOf("to", 5); // return -1,左邊沒有 'to'
//
